function Enter-VsDev
{
  ...
  if ($preview){
    ...
    Enter-VsDevShell -SetDefaultWindowTitle -InstallPath 'C:\Program Files (x86)\Microsoft Visual Studio\2019\Preview' -StartInPath $pwd.Path -DevCmdArguments '-arch=x64 -no_logo'
  } else {
